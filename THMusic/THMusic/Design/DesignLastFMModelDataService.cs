...
{
    /// <summary>
    /// This <c>DesignLastFMModelDataService</c> class supporst the desing time data
    /// for the ImportLastFM page.
    /// </summary>
    public abstract class DesignLastFMModelDataService : ILastFMModelDataService
    {
        /// <summary>
        /// Creates the informatino created by the LAstFM service
        /// </summary>
        ...
        {
            return CreateDarkSideOfTheMoon();
        }
        ...
        /// <summary>
        /// Create the mock wiki data
        /// </summary>
        /// <returns>wiki data</returns>
