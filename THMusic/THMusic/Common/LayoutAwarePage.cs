...
namespace THMusic.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        {
            ////  Add an application bar to the bottom of every page
            //var appBar = new AppBar();
            ////  Add the user control as the content of the appbar
            //appBar.Content = new THMusic.CustomControls.GlobalAppBar();
            ////  Attach it to the LayoutAware page as a BottomAppBar.
