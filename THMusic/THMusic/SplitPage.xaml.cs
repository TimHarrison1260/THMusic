...
namespace THMusic
{
    ...
    /// </summary>
    public sealed partial class SplitPage : THMusic.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        {
            //  Can I access the ViewModel from here, in code
            //  YES YES YES YES YES
            var albumsVM = SimpleIoc.Default.GetInstance<ViewModel.AlbumsViewModel>();
            albumsVM.UniqueId = (DataModel.GroupId)navigationParameter;
